...
- Configuration fichier Hardening : 
  ...
  * 'PermitEmptyPasswords no' : Empêche la connexions avec des mots de passe vides.
  ...
  * 'X11Forwarding no' : Désactive la possibilité de transférer les connexion X11. - 'https://goteleport.com/blog/x11-forwarding/'
